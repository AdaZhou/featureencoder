...
public class NumericSplitEncoder implements FeatureEncoderIntf, java.io.Serializable{
    ...
    public static NumericSplitEncoder loadConf(List<String> lines, int featureStartIndex, boolean encodeSingle){
        NumericSplitEncoder conf=new NumericSplitEncoder();
